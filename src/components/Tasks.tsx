...
export function Tasks({ id, title, description, completed_at, onDeleteTask, onCompleteTask, onUncompleteTask }: TasksType) {
    ...
    if (completed_at === null) {
        return (
            <div className="container mx-auto">
                <div className="container p-4 bg-base-gray-500 border-2 border-base-gray-400 w-184 h-30 rounded-lg place-content-center">
                    <h1 className="text-l text-product-blue font-bold mb-2">{title}</h1>
                    <div className="flex justify-between w-176 h-10 gap-3">
                        <div className="flex items-start gap-2">
                            <button onClick={handleCompleteTask}>
                                <img className="w-6 inline-block cursor-pointer" src="./src/assets/img/uncheck.svg" alt="Uncheck" />
                            </button>
                            <p className="text-m font-regular text-base-gray-100 text-start">{description}</p>                            
                        </div>
                        <div>
                            <a onClick={handleDeleteTask} className="w-8 inline-block" href="#"><svg className="w-6 fill-base-gray-300 hover:fill-feedback-danger transition" viewBox="0 0 24 24">
                                <path d="M14.2021 9.98547H12.8716V15.5073H14.2021V9.98547Z" />
                                <path d="M11.4624 9.98547H10.1318V15.5073H11.4624V9.98547Z" />
        ...
        return (
            <div className="container mx-auto">
                <div className="container p-4 bg-base-gray-500 border-2 border-base-gray-400 w-184 h-30 rounded-lg place-content-center">
                    <h1 className="text-l text-product-purple-dark line-through font-bold mb-2">{title}</h1>
                    <div className="flex justify-between w-176 h-10 gap-3">
                        <div className="flex items-start gap-2">
                            <button onClick={handleUncompleteTask}>
                                <img className="w-6 inline-block cursor-pointer" src="./src/assets/img/check.svg" alt="Uncheck" />
                            </button>
                            <p className="text-m font-regular text-base-gray-300 line-through text-start">{description}</p>
                        </div>
                        <div>
                            <a onClick={handleDeleteTask} className="w-8 inline-block" href="#"><svg className="w-6 fill-base-gray-300 hover:fill-feedback-danger transition" viewBox="0 0 24 24">
                                <path d="M14.2021 9.98547H12.8716V15.5073H14.2021V9.98547Z" />
